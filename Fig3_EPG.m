...
schemes = { 'generic_inv', 'generic_SPAIRwsweep', ...
    'generic_SPAIRnosweep', 'generic_proset'} ;
lws = { 1, 1, 3, 3} ;
dn = {'inversion prepared', 'SPAIR with quadratic flip-angle sweep', 'SPAIR no sweep', 'single-shot'} ;
